#this source code is a exact copy of https://github.com/aws-samples/amazon-sagemaker-tensorflow-object-detection-api/blob/main/3_predict/visualization_utils.py
